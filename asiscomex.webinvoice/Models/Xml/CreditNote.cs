...
{
    [XmlRoot(ElementName = "CreditNote", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2")]
    public class CreditNote: InvoiceXmlDocument
    {
        ...
        [XmlElement(ElementName = "CreditNoteLine", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
        public CreditNoteLine CreditNoteLine { get; set; }
        [XmlElement(ElementName = "DATA", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2")]
        ...
        public string SchemaLocation { get; set; } = "urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2";
    }
}